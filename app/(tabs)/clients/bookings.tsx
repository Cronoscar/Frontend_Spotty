...
export default function() {
	...
	const [filter, setFilter] = useState<BookingFilter>(BookingFilter.ON_GOING);
...
function ToggleFilter( { filter, setFilter, isLoading }: ToggleFilterProps ) {
	return (
		<View
			style={ styles.filter }
		>
			<TouchableOpacity
				...
				accessibilityState={{ selected: filter === BookingFilter.ON_GOING }}
			...
			<TouchableOpacity
				accessibilityRole="radio"
				accessibilityState={{ selected: filter === BookingFilter.PAST }}
